...
notific8 = function () {
    ...
    function buildNotification(data) {
        ...
        document.getElementsByClassName(data.settings.namespace + '-heading')[0].textContent = data.settings.heading;
        document.getElementsByClassName(data.settings.namespace + '-message')[0].textContent = data.message;
